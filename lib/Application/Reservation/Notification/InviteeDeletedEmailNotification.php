...
require_once(ROOT_DIR . 'lib/Email/Messages/InviteeDeletedEmail.php');

class InviteeDeletedEmailNotification implements IReservationNotification
{
    /**
     * @var IUserRepository
     */
    ...
    function Notify($reservationSeries)
    {
        ...
        //print_r($_POST['invitationList']);exit();
        //foreach ($instance->UnchangedParticipants() as $userId)
        foreach ($_POST['invitationList'] as $userId)
        {
            //echo $userId;
            //exit();
