...
<div id="main" class="container-fluid">
    ...
    <div id="main" class="container-fluid row">
        <div class="col-md-2">
            {if $LoggedIn}
                <nav class="navbar navbar-inverse sidebar sidenav" role="navigation" style="border-color: white; padding-top: 50px; background-color: #fbfbfb;">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                            <ul class="nav navbar-nav emc-menu">
                                ...
                                <li class="dropdown">
                                    <a href="#shedule" class="dropdown-toggle" data-toggle="collapse" data-parent="#schedule">{translate key="Schedule"}</a>
                                    <div class="collapse in list-group-submenu" id="shedule">
                                        <ul class="list-group">
                                ...
                                {if $CanViewAdmin}
                                    <li class="dropdown">
                                        <a href="#application" class="dropdown-toggle" data-toggle="collapse" data-parent="#application">Application Management </a>
                                        <div class="collapse in list-group-submenu" id="application">
                                            <ul class="list-group">
                                ...
                                {if $CanViewResponsibilities}
                                    <li class="dropdown">
                                        <a href="#respon" class="dropdown-toggle" data-toggle="collapse" data-parent="#respon">{translate key="Responsibilities"} </a>
                                        <div class="collapse in list-group-submenu" id="respon">
                                            <ul class="list-group">
                                                {if $CanViewGroupAdmin}
                                ...
                                {if $CanViewReports}
                                    <li class="dropdown">
                                        <a href="#report" class="dropdown-toggle" data-toggle="collapse" data-parent="#report">{translate key="Reports"} </a>
                                        <div class="collapse in list-group-submenu" id="report">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <a href="{$Path}reports/{Pages::REPORTS_GENERATE}">{translate key=GenerateReport}</a>
                                                </li>
                                ...
                                {/if}
                                <li class="dropdown">
                                    <a href="#profile" class="dropdown-toggle" data-toggle="collapse" data-parent="#profile">Profile</a>
                                    <div class="collapse in list-group-submenu" id="profile">
                                        <ul class="list-group">
