...
class InviteeUpdatedEmailNotification extends InviteeAddedEmailNotification
{
    ...
    function Notify($reservationSeries)
    {
        ...
        foreach ($instance->UnchangedInvitees() as $userId)
        {
            ...
            $message = new ParticipantUpdatedEmail($owner, $invitee, $reservationSeries, $this->attributeRepository, $this->userRepository);
        ...
        foreach ($instance->RemovedInvitees() as $userId)
        {
            ...
            $message = new ParticipantDeletedEmail($owner, $invitee, $reservationSeries, $this->attributeRepository, $this->userRepository);
            ServiceLocator::GetEmailService()->Send($message);
        }
    }
}