...
class ReservationMovePresenter
{
	...
	public function PageLoad()
	{
        ...
        $obj->updateSeries($new_series['series_id'],$get_data_series['client_name'],$get_data_series['project'],$get_data_series['client_on_site'],$get_data_series['sample_on_site']);
