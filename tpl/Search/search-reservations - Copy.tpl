    ...
    <form role="form" name="searchForm" id="searchForm" method="post"
        ...
        <div class="form-group col-sm-4">
           {* <label for="userFilter" class="no-show">{translate key=User}</label>
            ...
            <select id="userId" name="userId" class="form-control selectpicker" data-live-search="true">
       ...
       {* <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-4">
            <label for="referenceNumber" class="no-show">Project No.</label>
            <input type="search" id="project_no" class="form-control" name="project_no"
                   placeholder="Project No."/>
            <span class="searchclear glyphicon glyphicon-remove-circle" ref="project_no"></span>
        </div>
