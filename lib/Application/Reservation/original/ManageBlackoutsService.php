...
class ManageBlackoutsService implements IManageBlackoutsService
{
	...
	public function Update($blackoutInstanceId, DateRange $blackoutDate, $resourceIds, $title, IReservationConflictResolution $reservationConflictResolution, IRepeatOptions $repeatOptions, $scope,$id,$st,$et)
	{
		if (!$blackoutDate->GetEnd()->GreaterThan($blackoutDate->GetBegin()))
		{
			return new BlackoutDateTimeValidationResult();
		...
		$obj->updatingTimeDateBlockout($id,$st,$et);
