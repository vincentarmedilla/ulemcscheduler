...
Order No. / Project No. {$OrderNo} <br/>
Request No. / Project No. {$RequestNo} <br/>
Client On Site: {$ClientOnSite} <br/>
Sample On Site: {$SampleOnSite} <br/>

<br/>
<a href="{$ScriptUrl}">Login to UL Scheduler</a>