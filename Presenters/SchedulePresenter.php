...
class SchedulePresenter extends ActionPresenter implements ISchedulePresenter {
    ...
    public function PageLoad(UserSession $user)
    {
        ...
        $resources = $this->_resourceService->GetScheduleResources2($activeScheduleId, $showInaccessibleResources, $user, $filter);
...
//		$rids= array();
        ...
        //echo '<pre>';print_r($reservationListing);echo '</pre>';
