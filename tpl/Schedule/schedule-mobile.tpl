                    ...
                    <td class="resourcename"
                        ...
                        {if $resource->CanAccess}
                            ...
                            <a href="{$href}" resourceId="{$resourceId}"
                               {if $resource->HasColor()}style="color:{$resource->GetTextColor()} !important"{/if}>{assign var="rname" value=" "|explode:$resource->Name}{$rname[1]} {$rname[2]} {$rname[3]} {$rname[4]} {$rname[5]} {$rname[6]} {$rname[7]}</a>
                        {else}
                            <i resourceId="{$resourceId}" class="resourceNameSelector fa fa-info-circle"
                               {if $resource->HasColor()}style="color:{$resource->GetTextColor()} !important"{/if}></i>
                            <span {if $resource->HasColor()}style="color:{$resource->GetTextColor()} !important"{/if}>{assign var="rname" value=" "|explode:$resource->Name}{$rname[1]} {$rname[2]} {$rname[3]} {$rname[4]} {$rname[5]} {$rname[6]} {$rname[7]}</span>
                        {/if}
                    </td>
