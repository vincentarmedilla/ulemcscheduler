...
interface IManageBlackoutsService
{
	 ...
	 * @return IBlackoutValidationResult
	 */
	public function Update($blackoutInstanceId, $st, $et, DateRange $blackoutDate, $resourceIds, $title, IReservationConflictResolution $reservationConflictResolution, IRepeatOptions $repeatOptions, $scope);
...
class ManageBlackoutsService implements IManageBlackoutsService
{
	...
	public function Update($blackoutInstanceId, $st,$et,DateRange $blackoutDate, $resourceIds, $title, IReservationConflictResolution $reservationConflictResolution, IRepeatOptions $repeatOptions, $scope)
	{
		...
		$obj->updatingTimeDateBlockout($blackoutInstanceId,$st,$et);
