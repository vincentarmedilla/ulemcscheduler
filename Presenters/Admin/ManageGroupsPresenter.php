...
class ManageGroupsPresenter extends ActionPresenter
{
    ...
    public function PageLoad()
    {
       ...
       /* $this->page->BindResources($this->resourceRepository->GetResourceList());*/
        ...
        $user = $userR->LoadById(ServiceLocator::GetServer()->GetUserSession()->UserId);
    ...
    public function ChangeGroupAdmin()
    {
        ...
        if($_POST['group_admin'] == '1') {
            $obj->updateGroupId($groupId);
        } else {
            $obj->updateGroupings($_POST['group_admin'],$groupId);
        }
    }
