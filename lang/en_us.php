...
class en_us extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['CreateReservationHeading'] = 'New Booking';
		$strings['EditReservationHeading'] = 'Editing Booking %s';
		$strings['ViewReservationHeading'] = 'Viewing Booking %s';
		...
		$strings['Users'] = 'Users';
		$strings['OwnerUser'] = 'Owner/User';
		$strings['ClientName'] = 'Client Name';
		$strings['ProjectLead'] = 'Project Lead';
		$strings['ProjOrderNo'] = 'Project/Order No.';
		$strings['RequestNo'] = 'Request No.';
		...
		$strings['ReservationTitle'] = 'Title of booking';
		$strings['ReservationDescription'] = 'Description of booking';
		...
		$strings['ResourcesPhysicalHR'] = 'Resources (Physical and Human/Test Engineer)';
		...
		$strings['ReservationCreatedPreference'] = 'When I create a reservation';
		$strings['ReservationUpdatedPreference'] = 'When I update a reservation';
		$strings['ReservationDeletedPreference'] = 'When I delete a reservation';
		...
		$strings['Reservation'] = 'New Booking';
		...
		$strings['ParticipantDeletedSubjectWithResource'] = '%s Removed';
        ...
        $strings['InviteeAddedSubjectWithResource'] = 'Your Reservation Was Updated';
