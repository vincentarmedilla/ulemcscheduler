...
class ManageResourcesPage extends ActionPage implements IManageResourcesPage
{
    ...
    public function ProcessPageLoad()
    {
        ...
        $groupUsers = array();
        foreach($userGroup as $value) {
            $groupUsers[] = $obj->getUsersGroup($value);
        }
        ...
        $this->Set('users_engineer', $obj->getUserGroups($user->Groups));
        //$this->Set('all_users', $obj->getAllUsers());
        $this->Set('all_users', $obj->getUserGroups($user->Groups));
        $this->Set('schedules',$obj->fetchScheduleByGroup($user->Groups));
        $this->Set('resourceTyped',$gResourceType);
        $this->Set('resourceType',$gResourceType);
        $this->Set('schedules',$schedule_result);
        $this->Set('resourceAdmin',$obj->getResourceAdmins($user->Groups));
