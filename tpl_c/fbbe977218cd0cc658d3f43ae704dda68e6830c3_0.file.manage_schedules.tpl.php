<?php
/* Smarty version 3.1.30, created on 2020-05-24 13:02:38
  from "C:\xampp2\htdocs\scheduleremc\tpl\Admin\Schedules\manage_schedules.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5eca544e3c4058_57885151',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fbbe977218cd0cc658d3f43ae704dda68e6830c3' => 
    array (
      0 => 'C:\\xampp2\\htdocs\\scheduleremc\\tpl\\Admin\\Schedules\\manage_schedules.tpl',
      1 => 1590243420,
      2 => 'file',
    ),
  ),
...
function content_5eca544e3c4058_57885151 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->ext->_tplFunction->registerTplFunctions($_smarty_tpl, array (
  'display_periods' => 
  array (
    'compiled_filepath' => 'C:\\xampp2\\htdocs\\scheduleremc\\tpl_c\\fbbe977218cd0cc658d3f43ae704dda68e6830c3_0.file.manage_schedules.tpl.php',
    'uid' => 'fbbe977218cd0cc658d3f43ae704dda68e6830c3',
    'call_name' => 'smarty_template_function_display_periods_14514874875eca544e241d72_00131938',
  ),
  'display_slot_inputs' => 
  array (
    'compiled_filepath' => 'C:\\xampp2\\htdocs\\scheduleremc\\tpl_c\\fbbe977218cd0cc658d3f43ae704dda68e6830c3_0.file.manage_schedules.tpl.php',
    'uid' => 'fbbe977218cd0cc658d3f43ae704dda68e6830c3',
    'call_name' => 'smarty_template_function_display_slot_inputs_14514874875eca544e241d72_00131938',
  ),
));
if (!is_callable('smarty_function_html_options')) require_once 'C:\\xampp2\\htdocs\\scheduleremc\\lib\\external\\Smarty\\plugins\\function.html_options.php';
?>
...
>
    $(document).ready(function(){
        $('#addName').keyup(check_schedule);

        $("#quickLayoutConfig").on("keypress keyup",function(){
            if($(this).val() == '0'){
              $(this).val('');  
            }
        });
    ...
    function check_schedule() {
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response == 0){
                    $("#manage_schedule ").removeAttr("disabled");
                    $("#message").html("").addClass("error-msg");
                } else {
                    $("#manage_schedule").attr("disabled", true);
                    $("#message").html("Schedule Name Already Exist").addClass("error-msg");
...
?>
                                    <?php echo htmlspecialchars_decode($_smarty_tpl->tpl_vars['r']->value->GetName(), ENT_QUOTES);
...
?>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success save" id="manage_schedule" submit="1"><span class="glyphicon glyphicon-ok-circle"></span> Add</button>
...
'
                ...
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['resourceAdmin']->value, 'group', false, 'scheduleId');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['scheduleId']->value => $_smarty_tpl->tpl_vars['group']->value) {
?>
				{
					value:<?php echo $_smarty_tpl->tpl_vars['group']->value['group_id'];?>
...
/* smarty_template_function_display_periods_14514874875eca544e241d72_00131938 */
if (!function_exists('smarty_template_function_display_periods_14514874875eca544e241d72_00131938')) {
function smarty_template_function_display_periods_14514874875eca544e241d72_00131938($_smarty_tpl,$params) {
...
/*/ smarty_template_function_display_periods_14514874875eca544e241d72_00131938 */
/* smarty_template_function_display_slot_inputs_14514874875eca544e241d72_00131938 */
if (!function_exists('smarty_template_function_display_slot_inputs_14514874875eca544e241d72_00131938')) {
function smarty_template_function_display_slot_inputs_14514874875eca544e241d72_00131938($_smarty_tpl,$params) {
foreach ($params as $key => $value) {
$_smarty_tpl->tpl_vars[$key] = new Smarty_Variable($value, $_smarty_tpl->isRenderingCache);
}?>
