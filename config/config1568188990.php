...
t under the terms of the GNU General Public License as published bythe Free Software Foundation, either version 3 of the License, or(at your option) any later version.
 ...
 */
$conf['settings']['app.title'] = 'UL - EMC Scheduler';			// application title
$conf['settings']['default.timezone'] = 'Asia/Hong_kong';      // look up here http://php.net/manual/en/timezones.php
$conf['settings']['allow.self.registration'] = 'false';         	// if users can register themselves
$conf['settings']['admin.email'] = 'alvin.capil@ul.com';         // email address of admin user
...
$conf['settings']['script.url'] = 'http://localhost/ulemc/Web/'; 	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['phpmailer']['smtp.host'] = 'smtp.googlemail.com';               // 'smtp.company.com'
