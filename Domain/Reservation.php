...
class Reservation
{
    ...
    public function ChangeHr($hrIds)
    {
        $diff = new ArrayDiff($this->_hrIds, $hrIds);

        $this->addedHrs = $diff->GetAddedToArray1();
        $this->removedHrs = $diff->GetRemovedFromArray1();
        $this->unchangedHrs = $diff->GetUnchangedInArray1();

        $this->_hrIds = $hrIds;
        return count($this->addedHrs) + count($this->removedHrs);
    }
    ...
    public function AddedHrs()
    {
        return $this->addedHrs;
    }
    ...
    public function RemovedHrs()
    {
        return $this->removedHrs;
    }
    ...
    public function UnchangedHrs()
    {
        return $this->unchangedHrs;
    }
