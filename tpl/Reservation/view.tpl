        ...
        <div id="reservationFormDiv">
            <div class="row">
                ...
                <div id="reservationDetails" class="{$detailsCol}">
                    ...
                    {/if}
                    <div class="col-xs-12">
                        <div><label>Client Name</label>&nbsp;{$resourcedetails['client_name']}</div>
                        <div><label>Order No. / Project No.</label>&nbsp;{$resourcedetails['project']}</div>
                        <div><label>Request No.</label>&nbsp;{$resourcedetails['request_no']}</div>
                        <div><label>Client on site</label>&nbsp;{if $resourcedetails['client_on_site'] neq ''} Yes {else} No {/if}</div>
                        <div><label>Sample on site</label>&nbsp;{if $resourcedetails['sample_on_site'] neq ''} Yes {else} No {/if}</div>
                    </div>
                </div>
                        ...
                        <div id="reservationParticipation">
                            ...
                            {if $ShowUserDetails}
                                <div id="ro-participantList">
                                    <label>{*{translate key='ParticipantList'}*}Project Lead/Engineers</label>
                                ...
                                <div id="ro-inviteeList">
                                    <label>{*{translate key='InvitationList'}*} Human Resource/Test Engineers</label>
                ...
                {if $ShowReservationDetails}
                    <div class="col-xs-12 buttons">
                        <div class="pull-right">
                            ...
                            <button type="button" class="btn btn-default" onclick="window.location.href='dashboard.php';">
                                {translate key='Close'}
                            </button>
