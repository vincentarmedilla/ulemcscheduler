<?php
/* Smarty version 3.1.30, created on 2020-05-24 13:00:05
  from "C:\xampp2\htdocs\scheduleremc\tpl\Admin\Users\manage_users.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5eca53b50316e3_23876437',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cdfeee3d672c6f9b27673d6d3721563c525cd980' => 
    array (
      0 => 'C:\\xampp2\\htdocs\\scheduleremc\\tpl\\Admin\\Users\\manage_users.tpl',
      1 => 1590243420,
      2 => 'file',
    ),
  ),
...
function content_5eca53b50316e3_23876437 (Smarty_Internal_Template $_smarty_tpl) {
...
>
    $(document).ready(function(){
        $('#user-filter').on('change', function() {
            var id = this.value;
            window.location.href = "manage_group_users.php?uid="+id;
        });
...
<div id="page-manage-users" class="admin-page">
    ...
    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['test_variable']->value, 'item');
if ($_from !== null) {
...
">&nbsp;
                ...
                <td>
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-default update edit updateUser">
...
foreach ($_from as $_smarty_tpl->tpl_vars['myId']->value => $_smarty_tpl->tpl_vars['i']->value) {
?>
                    					<option value="<?php echo $_smarty_tpl->tpl_vars['i']->value['schedule_id'];?>
">
