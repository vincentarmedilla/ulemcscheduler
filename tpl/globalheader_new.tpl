                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                            <ul class="nav navbar-nav emc-menu">
                                <li><a href="{$Path}{Pages::DASHBOARD}"><img src="img/emc_dashboard_white.png" height="30" width="30">
                                ...
                                <li class="dropdown">
                                    ...
                                    <img src="img/emc_calendar_white.png" height="30" width="30">
                                ...
                                {if $CanViewAdmin}
                                    <li class="dropdown">
                                        ...
                                        <img src="img/emc_setting_white.png" height="30" width="30">
                                ...
                                {if $CanViewReports}
                                    <li class="dropdown">
                                        ...
                                        <img src="img/emc_reports_white.png" height="30" width="30">
                                ...
                                <li class="dropdown">
                                    ...
                                    <img src="img/emc_user_white.png" height="30" width="30"><span class="texthide">Profile</span></a>
